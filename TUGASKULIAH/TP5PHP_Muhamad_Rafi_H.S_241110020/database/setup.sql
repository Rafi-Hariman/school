-- Database Setup untuk BAB 5 PHP Database
-- Database: bimbel

-- Drop database jika sudah ada (untuk fresh install)
DROP DATABASE IF EXISTS bimbel;

-- Buat database bimbel
CREATE DATABASE bimbel CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- Gunakan database bimbel
USE bimbel;
...
-- Insert data sample untuk tabel Siswa
INSERT INTO siswa VALUES
(1, 'Ahmad Rizky', '081234567890', 'SMAN 1 Jakarta'),
(2, 'Siti Aminah', '081234567891', 'SMAN 2 Bandung'),
(3, 'Budi Santoso', '081234567892', 'SMA Negeri 3 Surabaya'),
(4, 'Dewi Lestari', '081234567893', 'SMAN 1 Yogyakarta'),
(5, 'Eko Prasetyo', '081234567894', 'SMA Taruna Nala');

-- Insert data sample untuk tabel Akademik
...
-- Insert data sample untuk tabel Program_bimbel
INSERT INTO program_bimbel VALUES
...
-- Insert data sample untuk tabel Detail_bimbel
INSERT INTO detail_bimbel VALUES
(1, 1, 1, 'Sangat Baik', 'Pertahankan dan tingkatkan pencapaianmu!'),
(1, 2, 1, 'Baik', 'Perlu lebih banyak latihan soal'),
(2, 3, 2, 'Cukup Baik', 'Fokus pada grammar dan vocabulary'),
(3, 4, 1, 'Baik', 'Paham konsep dasar dengan baik'),
(3, 5, 1, 'Sangat Baik', 'Excellent dalam praktikum'),
(4, 6, 3, 'Baik', 'Aktif dalam diskusi'),
(5, 7, 2, 'Cukup Baik', 'Perlu meningkatkan hafalan');
