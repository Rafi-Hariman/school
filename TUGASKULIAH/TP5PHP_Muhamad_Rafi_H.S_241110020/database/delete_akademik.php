...
$query_delete = "DELETE FROM akademik WHERE id_mapel=9";
...
<head>
    ...
    <title>Delete Akademik - Tugas 5.4</title>
...
<body>
    ...
    <div class="container mt-4">
        <h4 class="mb-3"><i class="bi bi-trash me-2"></i>Delete Mata Pelajaran <small class="text-muted">(Tugas 5.4)</small></h4>
        ...
        <?php elseif ($success && $affected_rows == 0): ?>
            <div class="alert alert-info"><i class="bi bi-info-circle me-2"></i>Tidak ada data yang dihapus (ID 9 tidak ditemukan)</div>
        <?php else: ?>
