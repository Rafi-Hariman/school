...
$query_update = "UPDATE siswa SET nama_siswa='Raka' WHERE id_siswa=26";
...
<head>
    ...
    <title>Update Siswa - BAB 5</title>
...
<body>
    ...
    <div class="container mt-4">
        <h4 class="mb-3"><i class="bi bi-pencil me-2"></i>Update Data Siswa</h4>
        ...
        <?php elseif ($success && $affected_rows == 0): ?>
            <div class="alert alert-info"><i class="bi bi-info-circle me-2"></i>Tidak ada data yang diubah (ID 26 tidak ditemukan)</div>
        <?php else: ?>
